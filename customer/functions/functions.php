...
$run_customer = mysqli_query($dab,$get_customer_pic);
...
$run_orders = mysqli_query($dab,$get_orders);
$count_orders = mysqli_num_rows($run_orders);
	if($count_orders>0)
	{
		echo "<div style='padding:10px;'>
<h1 style='color:red;'>Important!</h1>
<h2>You have  $count_orders pendeing orders</h2>
<h3>You can see your order details by cliking through <a href='my_account.php?my_orders'>Order Detail</a><br>or you can pay offline <a href='pay_offline.php'>pay offline</a></h3>
	...
	else
	{
		echo "<div style='padding:10px;'>
<h1 style='color:red;'>Important!</h1>
<h2>You have  no pendeing orders</h2>
<h3>You can see your order details by cliking through <a href='my_account.php?my_orders'>Order Detail</a></h3>
