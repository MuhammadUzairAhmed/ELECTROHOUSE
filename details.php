...
{
	$pro_id = $_GET['pro_id'];
$products_get = "select * from products where product_id='$pro_id'";
	...
	$h = $row_products['product_img2'];
	$i = $row_products['product_img3'];	
	$j = $row_products['product_keyword'];
	

echo "
<div id='single_product'>
<h3>$b</h3>
<img src='admin_area/product_images/$g' width='180' height='180'>
<img src='admin_area/product_images/$h' width='180' height='250'>
<img src='admin_area/product_images/$i' width='180' height='250'><br>
<p><b>price: $ $f</b></p>
<p><br>$e</b></p>
<p>Product Keyword : <b>$j</b></p>
<a href='index.php' style='float:left;color:white;'>Go Back</a>
<a href='index.php?add_cart=$a'><button style='float:right;color:white;background-color:black;'>Add to Cart</button></a>
</div>
";
